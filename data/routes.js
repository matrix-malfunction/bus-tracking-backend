...
const routes = [
  ...
  // CANONICAL SCHEMA: routeCoords + stop objects { stopId, name, lat, lng }
  // INVARIANT: routeCoords[i] === stops[i] for every index.
  // Reverse both arrays together for INBOUND — never one alone.
  // ─────────────────────────────────────────────────────────────
  {
    id: "VLR_11_DEMO",
    name: "Katpadi Railway Station \u2013 Bagayam (Demo)",
    routeName: "Katpadi Railway Station \u2013 Bagayam (Demo)",
    shortName: "KPD-BGM-D",
    color: "#e11d48",
    routeColor: "#e11d48",
    district: "Vellore",
    ...
    stops: [
      { stopId: "katpadi_main",     name: "Katpadi Bus Stand (Main)",      lat: 12.9772, lng: 79.1368 },
      { stopId: "katpadi_junction", name: "Katpadi Junction Bus Stop",     lat: 12.9711, lng: 79.1372 },
      { stopId: "katpadi_chittoor", name: "Katpadi \u2013 Chittoor Bus Stand", lat: 12.9663, lng: 79.1375 },
      { stopId: "custom_stop_117",  name: "Vellore Mofussil Bus Terminus", lat: 12.9346, lng: 79.1384 },
      { stopId: "custom_stop_116",  name: "CMC Bus Stop",                  lat: 12.9245, lng: 79.1333 },
      { stopId: "custom_stop_138",  name: "Infantry Road Stop",            lat: 12.9113, lng: 79.1305 },
      { stopId: "custom_stop_140",  name: "Vellore Cantonment Station",    lat: 12.9107, lng: 79.1276 },
      { stopId: "custom_stop_134",  name: "Vellore (Near Jail) Bus Stop",  lat: 12.8881, lng: 79.1221 },
      { stopId: "bagayam",          name: "Bagayam Bus Stop",              lat: 12.8801, lng: 79.1348 },
    ],
  }
